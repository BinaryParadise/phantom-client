...
let SysProxyBackupPlist = NSHomeDirectory() + "/Library/Preferences/com.binaryparadise.phantom.system_proxy_backup.plist"

class PhantomXTool: NSObject {
    static let usage = "Usage: PhantomXTool -mode <global|manual|pac|off|restore|backup> -pac <url> -http-port <port> -sock-port <port>"
